...
const variantStyles: Record<PopupVariant, { bg: string; headerBg: string; closeBtn: string; settingsBtn: string }> = {
  default: {
...
export default function PopupBase({ title, variant, onClose, onSettings, children }: PopupBaseProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 style={{ margin: 0, fontSize: '18px', fontWeight: 600, color: '#333' }}>{title}</h1>
